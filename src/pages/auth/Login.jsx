  ...
  return (
   <div className="min-h-screen bg-white flex flex-col items-center justify-start   pb-5 px-4 ">
      ...
      <div className="text-center mb-6">
        <h1 className="text-3xl font-extrabold text-[#1a2a5e]">Welcome Back</h1>
      ...
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-lg px-8 py-8 mb-3">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link to="/auth" className="text-[#1a2a5e] font-medium hover:underline">
            Sign Up
          </Link>
        </p>
        {/* Divider */}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-black text-white font-semibold text-sm transition hover:bg-gray-900 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed mt-4"
        >
          {googleLoading ? (
            <svg className="animate-spin h-4 w-4" viewBox="0 0 24 24" fill="none">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
