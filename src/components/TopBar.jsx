...
const TopBar =({ user, searchQuery, onSearchChange, onMenuToggle, mobileOpen }) =>{
    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm h-16 flex items-center px-4 gap-4">
      ...
      <div className="flex-1 max-w-xl mx-auto relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-[#f0f3fa] border border-transparent text-sm text-gray-700 placeholder-gray-400 outline-none focus:border-[#1a2a5e]/30 focus:bg-white transition"
        />
      </div>
